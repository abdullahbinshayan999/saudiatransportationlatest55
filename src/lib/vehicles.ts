...
export const vehicles: Vehicle[] = [
  ...
  { slug: "gmc", name: "GMC Yukon", seater: 7, bags: 5, hourly: 200,
    ...
    image: gmcImg },
  { slug: "hiace", name: "Toyota Hiace", seater: 11, bags: 10, hourly: 180,
    description: "Perfect for small groups. Seats up to 11 passengers with space for 10 bags — ideal for Umrah groups.",
    image: hiaceImg },
  { slug: "coaster", name: "Toyota Coaster", seater: 18, bags: 20, hourly: 350,
    description: "Best for medium groups. Comfortable seating for 18 passengers with luggage capacity up to 20 bags.",
    image: coasterImg },
